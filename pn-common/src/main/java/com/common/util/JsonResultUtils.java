...
public final class JsonResultUtils {
     ...
     * @return
     */
    public static JsonResult jsonResult(Integer code, String msg) {
     ...
     * @return
     */
    private static JsonResult jsonResult(Integer code, String msg, List<?> data, int countPage) {
     ...
     * @return
     */
    private static JsonResult jsonResultNoData(Integer code, String msg) {
        JsonResult r = JsonResult.getInstance();
        r.setCode(code);
        r.setMsg(msg);
        return r;
